    ...
    if (this.reloadFlg)
    {
        ...
        switch (no)
        {
            ...
            case 1: // ハル2
                this.releaseModel(0, gl);
                this.createModel();
                this.models[0].load(gl, LAppDefine.MODEL_HARU_B);
                break;
            case 2: // しずく
                this.releaseModel(0, gl);
                this.createModel();
            ...
            case 4:
                this.releaseModel(0, gl);
                this.createModel();
                this.models[0].load(gl, LAppDefine.MODEL_1);
                break;
            case 5:
                this.releaseModel(0, gl);
                this.createModel();
                this.models[0].load(gl, LAppDefine.MODEL_2);
                break;
            case 6:
                this.releaseModel(0, gl);
                this.createModel();
                this.models[0].load(gl, LAppDefine.MODEL_3);
                break;
            case 7:
                this.releaseModel(0, gl);
                this.createModel();
                this.models[0].load(gl, LAppDefine.MODEL_4);
                break;
            case 8:
                this.releaseModel(0, gl);
                this.createModel();
                this.models[0].load(gl, LAppDefine.MODEL_5);
                break;
            default:
                break;
        }
